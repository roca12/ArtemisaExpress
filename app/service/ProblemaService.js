...
class ProblemaService{
   ...
   */
    async crearProblema({titulo, juez, alias, dificultad, tema_1, tema_2, tema_3, tema_4, url}){
        ...
        return await ProblemaModel.crearProblema({titulo, juez, alias, dificultad, tema_1, tema_2, tema_3, tema_4, url});
    }
   ...
   */
    async actualizarProblema(id, {titulo, juez, alias, dificultad, tema_1, tema_2, tema_3, tema_4, url}) {
        ...
        if (Object.keys(datos).length === 0) throw new Error("Debes enviar al menos un campo para actualizar");
